...
在 [解构赋值](https://hzzzzzzzq.github.io/Blog/1c84e2dc.html) 和 [数组的扩展](https://hzzzzzzzq.github.io/Blog/15284f3d.html) 中，我们分别提到过对象的解构赋值以及扩展运算符。

我们来看看扩展运算符在对象中的使用。

### 解构赋值

我们来回顾一下 [解构赋值](https://hzzzzzzzq.github.io/Blog/1c84e2dc.html) 。
...
- 将对象转为真正的 [Map 结构](https://hzzzzzzzq.github.io/Blog/e5a445b0.html)
...
- 将 [`Map` 结构](https://hzzzzzzzq.github.io/Blog/e5a445b0.html)转为对象
